...
interface ISafeTxn {
  ...
  function addProduct(uint32 _sellerId, uint256 _amount) external returns (bool);
  ...
  event ProductRegistered(address indexed buyer, address indexed seller, uint32  indexed productId, uint256 timestamp, uint256 value);
